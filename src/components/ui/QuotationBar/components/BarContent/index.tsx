...
const BarContent = (props: BarContentProps) => {
  ...
  return (
    <>
      ...
      >
        <div className={'absolute left-0 top-0 z-10 h-full w-2 bg-linear-to-r from-card'} />
        <div className={'absolute right-0 top-0 z-10 h-full w-2 bg-linear-to-l from-card'} />
        <div
          ref={textRef}
